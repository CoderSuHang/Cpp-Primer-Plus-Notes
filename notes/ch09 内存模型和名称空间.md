...
* 2、如果在代码块中定义了变量，则该变量的存在时间和作用域将被限制在该代码块内。
  ...
  * 如果内部代码块中的websight改成teledeli，使得由两个同名的变量：
    ...
    * ![image-20231101104013732](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20231101104013732.png)
...
* 5、自动变量和栈
  ...
  * 栈时LIFO（后进先出），集最后加入到栈中的变量首先被弹出。（栈是弹夹结构）
    ...
    * ![image-20231101112224009](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20231101112224009.png)

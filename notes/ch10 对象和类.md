...
* 用于两个对象比较的方法原型如下：
  ...
  * 假设要对Stock对象 stock1 和 stock2 进行比较，并将其中股价总值最高的哪一个赋给top对象，则可以使用下面两条语句之一：
    ...
    * ![image-20231204100447005](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20231204100447005.png)
...
* 注意：
  ...
  * ![image-20231204101906998](C:\Users\10482\AppData\Roaming\Typora\typora-user-images\image-20231204101906998.png)
